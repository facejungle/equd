 ...
 * @type {string[]}
 */
module.exports.externals = module.exports.packages.reduce(
    ( externals, package ) => {
        externals[ package ] = [
            'wp',
 ...
 * @type {string[]}
 */
module.exports.proxyExternals = module.exports.packages.reduce(
    ( externals, package ) => {
        externals[ package ] = [
            'cf',
            'vendor',
 ...
 * @type {Object}
 */
module.exports.providers = module.exports.packages.reduce(
    ( providers, package ) => {
