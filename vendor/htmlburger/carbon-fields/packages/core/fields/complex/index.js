...
class ComplexField extends Component {
    ...
    render()
    {
        ...
        { value.map(
            ...
            <ComplexGroup key={ `${ group[ groupFilterKey ] }-${ index }` } { ...onGroupSetup(
                group, {
                    index,
...
addFilter(
    'carbon-fields.field-wrapper', 'carbon-fields/core', ( OriginalField ) => ( props ) => {
    const { field } = props;
...
addFilter(
    'carbon-fields.complex.validate', 'carbon-fields/core', ( field, value ) => {
    const {
                min,
                labels,
                required
