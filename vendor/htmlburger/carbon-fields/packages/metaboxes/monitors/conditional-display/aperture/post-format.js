 ...
 */
addFilter(
    'carbon-fields.conditional-display-post-format.classic', 'carbon-fields/metaboxes', () => {
 ...
 */
addFilter(
    'carbon-fields.conditional-display-post-format.gutenberg', 'carbon-fields/metaboxes', ( ) => {
    return pipe(
